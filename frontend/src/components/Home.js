      ...
      <div className="w-full min-h-screen prevent-horizontal-scroll">
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-10 sm:bottom-20 left-4 sm:left-10 w-24 h-24 sm:w-48 sm:h-48 bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-full blur-lg sm:blur-3xl animate-float-gentle" style={{ animationDelay: '1.0s' }}></div>
          </div>
